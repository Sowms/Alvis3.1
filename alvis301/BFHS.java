    ...
    double beamSearch() {
        ...
        while (!bigopen.isEmpty()) {
            ...
            while (!open.isEmpty()) {
                ...
                closed.add(nodePair);
                //node.setState(alvis3.iitm.ac.in.State.closed);
                ...
                if (aNode != null) {
                    ...
                    for (Edge e : adjEdgeList) {
                        ...
                        if ((nodeID1.equals(aNode.getNodeID()))
                            ...
                            // e.setState(alvis3.iitm.ac.in.State.closed);
                            //updateEdge(e);
                            break;
                        }
                    }
                    ...
                    if (nParent != null) {
                        ...
                        for (Edge e : adjEdgeList) {
                            ...
                            if ((nodeID1 == open1.get(0).getNodeID())
                               ...
                               // e.setState(alvis3.iitm.ac.in.State.open);
                                // updateEdge(e);
                                Node n = open1.get(0);
                               // n.setState(alvis3.iitm.ac.in.State.open);
                                // updateNode(n);
                                break;
                            }
                        }
                    ...
                    if (nParent != null) {
                        ...
                        for (Edge e : adjEdgeList) {
                            ...
                            if ((nodeID1 == x.get(0).getNodeID())
                                ...
                                //e.setState(alvis3.iitm.ac.in.State.unvisited);
                                //updateEdge(e);
                                Node n = x.get(0);
                                //n.setState(alvis3.iitm.ac.in.State.unvisited);
                                //updateNode(n);
                                display();
                                break;
                            }
